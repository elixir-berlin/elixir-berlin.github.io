...
gulp.task('watch', function () {
    ...
    gulp.watch(['_config.yml', '*.html', '_includes/svgs/*', 'newsletter/*.html', 'privacy-policy/*', 'download/*.html', 'status/*', 'prenet/*', 'prenet/*/*', 'testnet/*', 'testnet/*/*', '_includes/*.html', '_includes/*/*.html', '_layouts/*.html', '_layouts/*/*.html', '_jobs/*', '_team/*', '_posts/*', '_drafts/*', 'js/*.js', 'images/*', 'blog/*'], ['jekyll-rebuild']);
});
